...
const AskQuestion = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (User) {
      if (questionTitle && questionBody && questionTags) dispatch(askQuestion({questionTitle,questionBody,questionTags,userPosted: User.result.name,userId:User?.result?._id},navigate));
        ...
        <form onSubmit={handleSubmit}>
          <div className="ask-form-container">
            <label htmlFor="ask-ques-title">
              <h4>Title</h4>
              <p>Imagine you're asking a question to another person</p>
            ...
            <label htmlFor="ask-ques-body">
              <h4>Body</h4>
              <p>Include all the information req to answer your question</p>
